...
package cn.allms.familyaccount.utils.sdkinit;

import android.app.Application;

import cn.allms.familyaccount.XyjApp;
import cn.allms.familyaccount.core.BaseActivity;
import cn.allms.familyaccount.utils.MMKVUtils;
...
//        XHttpSDK.addInterceptor(new CustomExpiredInterceptor());
    ...
    private static void initXPage(Application application) {
        PageConfig.getInstance()
                ...
                .debug(XyjApp.isDebug() ? "PageLog" : null)
                .enableWatcher(XyjApp.isDebug())
